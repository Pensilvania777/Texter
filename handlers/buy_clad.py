            ...
            if rare:
                ...
                if result is None:
                    if launge == "ru":
                        ...
                        await bot.send_photo(call.message.chat.id, photo=photo_data, caption=f"Товар: {item}\n"
                        ...
                        await bot.send_photo(call.message.chat.id, photo=photo_data, caption=f"Product: {item}\n"
                    ...
                    if launge == "ru":
                        ...
                        await bot.send_message(call.message.chat.id,f"Товар: {item}\n"
                                                                                       f"Цена за грамм: {price} $\n"
                                                                                       f"Граммовка: {gram} грамм\n"
                                                                                       f"Цена: {price_item} $\n",
                                             reply_markup=keyboard)
                        ...
                        await bot.send_message(call.message.chat.id, f"Product: {item}\n"
                                                                                       f"Price per gram: {price} $\n"
                                                                                       f"Gram: {gram} gram\n"
                                                                                       f"Price: {price_item} $\n",
                                             reply_markup=keyboard)
